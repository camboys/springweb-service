...
import com.camboys.springboot.config.auth.dto.OAuthAttributes;
import com.camboys.springboot.config.auth.dto.SessionUser;
import com.camboys.springboot.domain.user.User;
import com.camboys.springboot.domain.user.UserRepository;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        httpSession.setAttribute("user", new SessionUser(user));//세선에 사용자 정볼르 저장하기 위한 Dto 클래스
